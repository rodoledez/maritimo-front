...
/**
 * Cuerpo presentacional de un tracking de ShipsGo (estado, progreso, ruta,
 * contenedores y seguidores). Compartido por el diálogo de detalle de
 * shipments-tracking y por el detalle de una reserva integrada.
 */
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <DetailRow label="Contenedor primario">
            <span className="font-mono">{t.containerNumber ?? "—"}</span>
          </DetailRow>
